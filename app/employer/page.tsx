  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Welcome to your employer dashboard, {user.username}.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Recent Bons</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">No recent bons to display.</p>
          </CardContent>
        </Card>
      </div>
    </div>
