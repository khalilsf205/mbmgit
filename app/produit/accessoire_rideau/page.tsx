...
const products = [
  ...
  {
    id: 2,
    name: 'Boite a ressort',
    image: '/boite_ressort.kpg.jpg',
  ...
  },
  {
    ...
    name: 'Ressort',
    image: '/ressort.jpg',
    category: 'Accessoires rideau métallique'
  },
  {
    id: 4,
    name: 'Support universel',
    image: '/support_universel.jpg',
    category: 'Accessoires rideau métallique'
  },
  {
    id: 5,
    ...
    <div className="min-h-screen flex flex-col ">
      ...
      <main className="flex-1 py-12 px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold mb-12">Accessoire rideau métallique</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => (
              <Link 
                key={product.id} 
                href={`/produit/accessoire_rideau/${product.id}`}
                className="group"
              >
